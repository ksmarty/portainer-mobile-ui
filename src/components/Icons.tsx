...
export const IconBroom = (p: IconProps) => (
  <Svg {...p}>
    <path d="m13 4-2-2-1 1 2 2 1-1Z" />
    <path d="m19.5 3.5-9 9" />
    <path d="m13.7 11.7 2.6-2.6a2 2 0 0 1 2.8 2.8l-2.6 2.6-2.8-2.8Z" />
    <path d="M8.5 8.5 4.7 4.7a5.7 5.7 0 0 0 1.6 6.9l2.2 2.2a5.7 5.7 0 0 0 6.9 1.6L5 5.4a5.7 5.7 0 0 0 1.5 6.2l2.2 2.2" />
  </Svg>
)
